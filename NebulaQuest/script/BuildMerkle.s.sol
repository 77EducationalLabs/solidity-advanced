...
contract BuildMerkle is Script, ScriptHelper {
    ...
    uint256 private numberOfUsersWhitelisted = elements.readUint(".numberOfUsersWhitelisted");

    // make three arrays the same size as the number of leaf nodes
    bytes32[] private leafs = new bytes32[](numberOfUsersWhitelisted);
    string[] private inputs = new string[](numberOfUsersWhitelisted);
    string[] private outputs = new string[](numberOfUsersWhitelisted);
